...
{
	if (m_dimension != r.m_dimension) throw IllegalArgumentException("Region::combineRegion: Region has different number of dimensions.");
...
{
	if (m_dimension != p.m_dimension) throw IllegalArgumentException("Region::combineRegion: Point has different number of dimensions.");
