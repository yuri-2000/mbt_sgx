	...
	: m_dimension(startPoint.m_dimension)
{
	if (startPoint.m_dimension != endPoint.m_dimension)
		throw Tools::IllegalArgumentException("LineSegment::LineSegment: Points have different dimensionalities.");
...
{
	if (m_dimension != l.m_dimension) throw IllegalArgumentException("LineSegment::operator ==: LineSegments have different number of dimensions.");
...
// IObject interface
//
Tools::Geometry::LineSegment* Tools::Geometry::LineSegment::clone() throw (Tools::NotSupportedException)
{
...
unsigned long Tools::Geometry::LineSegment::loadFromByteArray(byte* const data)
{
	byte* ptr = data;
...
void Tools::Geometry::LineSegment::storeToByteArray(unsigned long& len, byte** data)
{
...
{
	if (m_dimension == 1) throw Tools::NotSupportedException("LineSegment::getMinimumDistance: Use an Interval instead.");
	if (m_dimension != 2) throw Tools::NotSupportedException("LineSegment::getMinimumDistance: Distance for high dimensional spaces not supported!");
...
{
	if (m_dimension == 1) throw Tools::NotSupportedException("LineSegment::getAngleOfPerpendicularRay: Use an Interval instead.");
	if (m_dimension != 2) throw Tools::NotSupportedException("LineSegment::getAngleOfPerpendicularRay: Distance for high dimensional spaces not supported!");
