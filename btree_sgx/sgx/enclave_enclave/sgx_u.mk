...
App_Cpp_Files := $(UNTRUSTED_DIR)/sample.cpp $(UNTRUSTED_DIR)/storagemanager/Buffer.cpp $(UNTRUSTED_DIR)/storagemanager/DiskStorageManager.cpp $(UNTRUSTED_DIR)/storagemanager/MemoryStorageManager.cpp $(UNTRUSTED_DIR)/storagemanager/RandomEvictionsBuffer.cpp $(UNTRUSTED_DIR)/storagemanager/LruBuffer.cpp #$(UNTRUSTED_DIR)/spatialindex/SpatialIndexImpl.cpp # $(wildcard App/TrustedLibrary/*.cpp)
...
App_Link_Flags := $(SGX_COMMON_CFLAGS) -L$(SGX_LIBRARY_PATH) -l$(Urts_Library_Name) -lpthread /usr/local/lib/libtools.a 
...
$(UNTRUSTED_DIR)/enclave_u.c: $(SGX_EDGER8R) $(TRUSTED_DIR)/enclave.edl
	@cd $(UNTRUSTED_DIR) && $(SGX_EDGER8R) --untrusted ../$(TRUSTED_DIR)/enclave.edl --search-path ../$(TRUSTED_DIR) --search-path $(SGX_SDK)/include
	@echo "GEN  =>  $@"
